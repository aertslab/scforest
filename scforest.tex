...
\title{The Single Cell Technology Landscape}
...
\begin{center}
	...
	{\huge\textbf{Single Cell Technology}}

	\vspace{0.5cm}
	{\Large A visual overview}

	\vspace{1.5cm}

	{\large florian.derop@kuleuven.vib.be}\\
	\medskip
	{\large Latest version on \href{https://gitlab.com/fderop/scforest}{gitlab.com/fderop/scforest}}\\
	\medskip
	{\large \today}
	\vfill

	\includegraphics[width=0.4\textwidth]{kul.jpeg}
...
\eject \pdfpagewidth=120cm \pdfpageheight=100cm
...
[, no edge, calign=center, tier=base
	...
	[\href{https://www.nature.com/articles/nmeth.1315}{\textbf{mRNA-seq}}\\\citealt{tang2009}, edge=dotted, calign=child, calign child=3, fit=tight, tier=2009
		...
		[, empty, edge=dotted[\href{https://genomebiology.biomedcentral.com/articles/10.1186/s13059-015-0706-1}{\textbf{SUPeR-seq}}\\\citealt{fan2015}, edge=dotted, fit=tight, tier=2016]]
		[, empty[\href{https://www.nature.com/articles/nprot.2009.236}{\textbf{scRNA-seq}}\\\citealt{tang2010}, fit=tight, tier=2010]]
		[, empty, edge=dotted[\href{https://www.nature.com/articles/nbt.2282}{\textbf{Smart-seq}}\\\citealt{ramskold2012}, edge=dotted, calign=child, calign child=1, name=smart-seq, tier=2012
			[, empty[\href{https://www.nature.com/articles/nmeth.2639}{\textbf{Smart-seq2}}\\\citealt{picelli2013}, calign=child, calign child=2, fit=tight, name=smart-seq22013, tier=2013
				[, empty, no edge[\href{https://www.nature.com/articles/nbt.2967}{\textbf{C1 scRNA-seq}}\\Fluidigm\\\citealt{pollen2014}, no edge, fit=tight, name=c1_scrna-seq, tier=2014,
				]]
				[, empty[\href{https://www.nature.com/articles/nprot.2014.006}{\textbf{Smart-seq2}}\\\citealt{picelli2014}, fit=tight, name=smart-seq2, tier=2014
				...
				[, empty, edge=dotted, fit=tight[\href{https://www.cell.com/abstract/S0092-8674(15)00549-8}{\textbf{Drop-seq}}\\\citealt{macosko2015}, edge=dotted, calign=child, calign child=2, fit=tight, name=drop-seq, tier=2015
					[, empty, edge=dotted[\href{https://www.nature.com/articles/nmeth.4179}{\textbf{Seq-Well}}\\\citealt{gierahn2017}, edge=dotted, fit=tight, tier=2017
					]]
					...
					[, empty, edge=dotted[\href{https://www.nature.com/articles/nmeth.4177}{\textbf{CROP-seq}}\\\citealt{datlinger2017}, edge=dotted, fit=tight, tier=2017]]
				]]
			]]
		]]
	]]
...
[, no edge, tier=2012
	...
	[, empty, no edge[\href{https://www.nature.com/articles/nmeth.3728}{\textbf{scM\&T-seq\textsuperscript{\textbf{\large{+}}}}}\\\citealt{angermueller2016}, no edge, fit=tight, name=scmt-seq, tier=2016
		[, empty, no edge[\href{https://www.nature.com/articles/nmeth.4380}{\textbf{CITE-seq\textsuperscript{\textbf{\large{+}}}}}\\\citealt{stoeckius2017}, no edge, fit=tight, name=cite-seq, tier=2017]]
	]]
...
[, no edge, tier=2012
	...
	[, empty, no edge[\href{https://www.nature.com/articles/nmeth.2688}{\textbf{ATAC-seq\textsuperscript{\large{*}}}}\\\citealt{buenrostro2013}, no edge, calign=child, calign child=3, fit=tight, name=atac-seq, tier=2013
		[, empty, edge=dotted[\href{https://science.sciencemag.org/content/348/6237/910}{\textbf{sciATAC-seq}}\\\citealt{cusanovich2015}, edge=dotted, fit=tight, name=sciatac-seq, tier=2015
			...
			[, empty, edge=dotted[\href{https://www.nature.com/articles/s41587-019-0147-6}{\textbf{dsciATAC-seq}}\\\citealt{lareau2019}, edge=dotted, fit=tight, name=dsciatac-seq, tier=2019]]
		]]
		[, no edge, empty, name=prec1_scatac-seq[\href{https://www.nature.com/articles/nature14590}{\textbf{C1 scATAC-seq}}\\Fluidigm 2015\\\citealt{buenrostro2015}, no edge, fit=tight, name=c1_scatac-seq, tier=2015]]
		[, empty[\href{https://www.nature.com/articles/nmeth.4396}{\textbf{Omni-ATAC\textsuperscript{\large{*}}}}\\\citealt{corces2017}, fit=tight, name=omni-atac, tier=2017
		...
		[, edge=dotted, empty[\href{https://www.nature.com/articles/nmeth.4031}{\textbf{ATAC-see}}\\\citealt{chen2016}, edge=dotted, fit=tight, tier=2016]]
	]]
[, empty, no edge, [\href{https://www.nature.com/articles/nbt.3383}{\textbf{scChIP-seq}}\\\citealt{rotem2015}, no edge, fit=band, tier=2015]]
]
% genomics
...
\draw[squiggly] (smart-seq2.210) to[out=210, in=30] (chromium);
\draw[squiggly] (indrop) -- (chromium);
\draw[squiggly] (smart-seq22013) -- (c1_scrna-seq);
...
\draw[dotted, thick] (smart-seq2) to[out=320, in=175] (sccat-seq);
\draw[dotted, thick] (smart-seq2) -- (gt-seq);
\draw[dotted, thick] (omni-atac) to[out=182, in=45] (sccat-seq);
